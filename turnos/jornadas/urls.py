...
#asistencias 
    url(r'^eliminarasistencias/(?P<item>\d+)$', views.EliminarAsistencia,
        name='eliminarasistencia'),
    url(r'^editasistencia/(?P<item>\d+)$',
        views.AsistenciaEditar, name='editasistencia'),
#turnos
    url(r'^turnos/$', views.TurnoLista, name='turnos'),    
    url(r'^eliminaturno/(?P<item>\d+)$', views.EliminaTurno,
        name='eliminaturno'),
    url(r'^editaturno/(?P<item>\d+)$', views.EditaTurno,
        name='editaturno'),
